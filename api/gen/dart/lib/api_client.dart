  ...
  dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'ApiDescribeRepositoryReq':
          return ApiDescribeRepositoryReq.fromJson(value);
        case 'ApiJob':
          return ApiJob.fromJson(value);
        case 'ApiListJobRes':
          return ApiListJobRes.fromJson(value);
        case 'ApiListRepositoryRes':
          return ApiListRepositoryRes.fromJson(value);
        case 'ApiListVariableRes':
          return ApiListVariableRes.fromJson(value);
        case 'ApiPlaybook':
          return ApiPlaybook.fromJson(value);
        case 'ApiRepository':
          return ApiRepository.fromJson(value);
        case 'ApiRepositoryID':
          return ApiRepositoryID.fromJson(value);
        case 'ApiRunOpsReq':
          return ApiRunOpsReq.fromJson(value);
        case 'ApiRunOpsRes':
          return ApiRunOpsRes.fromJson(value);
        case 'ApiVariable':
          return ApiVariable.fromJson(value);
        case 'ApiVariableID':
          return ApiVariableID.fromJson(value);
        case 'InlineObject':
          return InlineObject.fromJson(value);
        case 'InlineObject1':
          return InlineObject1.fromJson(value);
        case 'PlaybookEnv':
          return PlaybookEnv.fromJson(value);
        case 'PlaybookTask':
          return PlaybookTask.fromJson(value);
        case 'ProtobufAny':
          return ProtobufAny.fromJson(value);
        case 'RpcStatus':
          return RpcStatus.fromJson(value);
        case 'TaskArgs':
          return TaskArgs.fromJson(value);
        default:
          Match match;
