...
void main() {
  ...
  group('tests for OpsServiceApi', () {
    ...
    //Future<Object> opsServiceUpdateRepository(String id, ApiRepository body) async 
    test('test opsServiceUpdateRepository', () async {
      // TODO
    });

    //Future<Object> opsServiceUpdateVariable(String id, ApiVariable body) async 
